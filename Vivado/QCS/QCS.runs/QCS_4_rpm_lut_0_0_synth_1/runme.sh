...
HD_PWD='/home/duncan/QCS/QCS.runs/QCS_4_rpm_lut_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QCS_4_rpm_lut_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QCS_4_rpm_lut_0_0.tcl
