...
reg [15:0] ch_counter;
wire [15:0] rpmlut_data;
reg [13:0] rpmlut_addr;
...
assign RPM[31:16] = 0;
assign REC = rec_reg;
assign rpmlut_data = data;
assign addr = rpmlut_addr;
assign en = (!clk_counter) ? 1 : 0;
...
//	else if (!ch_counter) clk_counter <= 900_000;
	else clk_counter <= 0; // Used to be clk_counter <= clk_counter;
end
