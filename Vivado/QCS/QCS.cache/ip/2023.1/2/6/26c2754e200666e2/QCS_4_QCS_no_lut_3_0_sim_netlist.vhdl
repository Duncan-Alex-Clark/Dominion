...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ QCS_4_QCS_no_lut_3_0_sim_netlist.vhdl
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_QCS_no_lut is
  ...
  signal clk_counter0 : STD_LOGIC_VECTOR ( 16 downto 1 );
  ...
  signal \clk_counter_reg[16]_i_3_n_1\ : STD_LOGIC;
  signal \clk_counter_reg[16]_i_3_n_2\ : STD_LOGIC;
  signal \clk_counter_reg[16]_i_3_n_3\ : STD_LOGIC;
  ...
  signal \NLW_clk_counter_reg[16]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \ch_counter[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ch_counter[10]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ch_counter[11]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ch_counter[12]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ch_counter[13]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ch_counter[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ch_counter[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ch_counter[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ch_counter[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ch_counter[5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ch_counter[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ch_counter[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ch_counter[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ch_counter[9]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \clk_counter[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \clk_counter[10]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \clk_counter[11]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \clk_counter[12]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \clk_counter[13]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \clk_counter[14]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \clk_counter[15]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \clk_counter[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \clk_counter[4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \clk_counter[5]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \clk_counter[6]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \clk_counter[7]_i_1\ : label is "soft_lutpair11";
  ...
  attribute ADDER_THRESHOLD of \clk_counter_reg[16]_i_3\ : label is 35;
...
\clk_counter[16]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\clk_counter[16]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\clk_counter_reg[16]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_clk_counter_reg[16]_i_3_CO_UNCONNECTED\(3),
      CO(2) => \clk_counter_reg[16]_i_3_n_1\,
      CO(1) => \clk_counter_reg[16]_i_3_n_2\,
      CO(0) => \clk_counter_reg[16]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
en_INST_0: unisim.vcomponents.LUT6
    generic map(
...
en_INST_0_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
en_INST_0_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
en_INST_0_i_3: unisim.vcomponents.LUT6
    generic map(
...
\rpmlut_addr[13]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\rpmlut_addr[13]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "QCS_4_QCS_no_lut_3_0,QCS_no_lut,{}";
