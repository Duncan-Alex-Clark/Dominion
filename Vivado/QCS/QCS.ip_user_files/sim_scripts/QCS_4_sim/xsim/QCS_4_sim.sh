...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot QCS_4_sim xil_defaultlib.QCS_4_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim QCS_4_sim -key {Behavioral:sim_1:Functional:QCS_4_sim} -tclbatch cmd.tcl -protoinst "protoinst_files/QCS_4.protoinst" -protoinst "protoinst_files/QCS_4_sim.protoinst" -protoinst "protoinst_files/QCS_1.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb QCS_4_sim.wdb xsim.dir libdpi.so)
