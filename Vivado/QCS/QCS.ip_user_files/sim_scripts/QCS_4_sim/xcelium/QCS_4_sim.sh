...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../QCS.gen/sources_1/bd/QCS_4_sim/ipshared/30ef" +incdir+"../../../../QCS.gen/sources_1/bd/QCS_4_sim/ipshared/30ef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../QCS.gen/sources_1/bd/QCS_4_sim/ipshared/30ef" +incdir+"../../../../QCS.gen/sources_1/bd/QCS_4_sim/ipshared/30ef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.QCS_4_sim xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.QCS_4_sim -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log QCS_4_sim_sc.so .tmp_log xcelium_lib waves.shm c.obj)
