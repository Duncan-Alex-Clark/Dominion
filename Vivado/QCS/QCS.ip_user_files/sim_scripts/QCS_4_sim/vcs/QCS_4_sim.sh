...
#
# Script generated by Vivado on Sat Oct 26 09:59:53 EDT 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : QCS_4_sim.sh
...
#
# Usage        : QCS_4_sim.sh
#                QCS_4_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                QCS_4_sim.sh [-reset_run]
#                QCS_4_sim.sh [-reset_log]
#                QCS_4_sim.sh [-help]
#
...
#                script (type 'QCS_4_sim.sh -help' for more information).
#
...
# script info
echo -e "QCS_4_sim.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./QCS_4_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../QCS.gen/sources_1/bd/QCS_4_sim/ipshared/30ef" +incdir+"../../../../QCS.gen/sources_1/bd/QCS_4_sim/ipshared/30ef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../QCS.gen/sources_1/bd/QCS_4_sim/ipshared/30ef" +incdir+"../../../../QCS.gen/sources_1/bd/QCS_4_sim/ipshared/30ef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.QCS_4_sim xil_defaultlib.glbl -o QCS_4_sim_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./QCS_4_sim_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key QCS_4_sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc QCS_4_sim_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./QCS_4_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: QCS_4_sim.sh [-help]\n\
Usage: QCS_4_sim.sh [-step]\n\
Usage: QCS_4_sim.sh [-lib_map_path]\n\
Usage: QCS_4_sim.sh [-reset_run]\n\
Usage: QCS_4_sim.sh [-reset_log]\n\
Usage: QCS_4_sim.sh [-keep_index]\n\
Usage: QCS_4_sim.sh [-noclean_files]\n\n\
