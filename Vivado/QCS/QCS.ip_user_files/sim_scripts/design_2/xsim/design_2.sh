...
simulate()
{
  xsim design_2 -key {Behavioral:sim_1:Functional:design_2} -tclbatch cmd.tcl -protoinst "protoinst_files/QCS_4.protoinst" -protoinst "protoinst_files/QCS_4_sim.protoinst" -protoinst "protoinst_files/design_2.protoinst" -protoinst "protoinst_files/QCS_1.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
