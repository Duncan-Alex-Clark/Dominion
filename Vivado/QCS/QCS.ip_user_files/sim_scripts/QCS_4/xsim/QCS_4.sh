...
#
# Script generated by Vivado on Sat Oct 26 09:59:39 EDT 2024
...
#
# Usage        : QCS_4.sh
#                QCS_4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                QCS_4.sh [-reset_run]
#                QCS_4.sh [-reset_log]
#                QCS_4.sh [-help]
#
...
# script info
echo -e "QCS_4.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./QCS_4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot QCS_4 xil_defaultlib.QCS_4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim QCS_4 -key {Behavioral:sim_1:Functional:QCS_4} -tclbatch cmd.tcl -protoinst "protoinst_files/QCS_4.protoinst" -protoinst "protoinst_files/QCS_4_sim.protoinst" -protoinst "protoinst_files/QCS_1.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb QCS_4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./QCS_4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: QCS_4.sh [-help]\n\
Usage: QCS_4.sh [-step]\n\
Usage: QCS_4.sh [-lib_map_path]\n\
Usage: QCS_4.sh [-reset_run]\n\
Usage: QCS_4.sh [-reset_log]\n\
Usage: QCS_4.sh [-keep_index]\n\
Usage: QCS_4.sh [-noclean_files]\n\n\
