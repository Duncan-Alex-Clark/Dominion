...
#                script (type 'QCS_4.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.QCS_4 xil_defaultlib.glbl -o QCS_4_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./QCS_4_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key QCS_4_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc QCS_4_simv.daidir vcs_lib c.obj)
