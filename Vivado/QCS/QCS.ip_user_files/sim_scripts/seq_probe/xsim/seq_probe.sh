...
#
# Script generated by Vivado on Fri Oct 25 19:44:02 EDT 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : seq_probe.sh
...
#
# Usage        : seq_probe.sh
#                seq_probe.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                seq_probe.sh [-reset_run]
#                seq_probe.sh [-reset_log]
#                seq_probe.sh [-help]
#
...
# script info
echo -e "seq_probe.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./seq_probe.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_utils_v3_0_10 -L c_reg_fd_v12_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_pipe_v3_0_6 -L xbip_dsp48_addsub_v3_0_6 -L xbip_addsub_v3_0_6 -L c_addsub_v12_0_15 -L c_gate_bit_v12_0_6 -L xbip_counter_v3_0_6 -L c_counter_binary_v12_0_16 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot seq_probe xil_defaultlib.seq_probe xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim seq_probe -key {Behavioral:sim_1:Functional:seq_probe} -tclbatch cmd.tcl -protoinst "protoinst_files/QCS_4.protoinst" -protoinst "protoinst_files/QCS_4_sim.protoinst" -protoinst "protoinst_files/seq_probe.protoinst" -protoinst "protoinst_files/design_2.protoinst" -protoinst "protoinst_files/QCS_1.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb seq_probe.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./seq_probe.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: seq_probe.sh [-help]\n\
Usage: seq_probe.sh [-step]\n\
Usage: seq_probe.sh [-lib_map_path]\n\
Usage: seq_probe.sh [-reset_run]\n\
Usage: seq_probe.sh [-reset_log]\n\
Usage: seq_probe.sh [-keep_index]\n\
Usage: seq_probe.sh [-noclean_files]\n\n\
