...
#                script (type 'seq_probe.sh -help' for more information).
#
...
design_libs=(xpm xbip_utils_v3_0_10 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 c_gate_bit_v12_0_6 xbip_counter_v3_0_6 c_counter_binary_v12_0_16 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.seq_probe xil_defaultlib.glbl -o seq_probe_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./seq_probe_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key seq_probe_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc seq_probe_simv.daidir vcs_lib c.obj)
