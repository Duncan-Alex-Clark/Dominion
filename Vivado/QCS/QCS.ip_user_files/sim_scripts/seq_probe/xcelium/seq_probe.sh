...
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 c_gate_bit_v12_0_6 xbip_counter_v3_0_6 c_counter_binary_v12_0_16 xil_defaultlib)
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.seq_probe xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.seq_probe -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log seq_probe_sc.so .tmp_log xcelium_lib waves.shm c.obj)
