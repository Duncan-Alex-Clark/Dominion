...
#
# Script generated by Vivado on Fri Oct 25 19:42:38 EDT 2024
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/QCS_4.protoinst" -protoinst "protoinst_files/QCS_4_sim.protoinst" -protoinst "protoinst_files/QCS_1.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
