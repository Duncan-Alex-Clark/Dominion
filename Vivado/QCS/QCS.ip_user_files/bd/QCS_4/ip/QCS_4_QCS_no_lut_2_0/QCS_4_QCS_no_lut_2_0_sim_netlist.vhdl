...
-- Date        : Fri Oct 25 19:45:20 2024
-- Host        : duncan-Ub22 running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/duncan/QCS/QCS.gen/sources_1/bd/QCS_4/ip/QCS_4_QCS_no_lut_2_0/QCS_4_QCS_no_lut_2_0_sim_netlist.vhdl
-- Design      : QCS_4_QCS_no_lut_2_0
...
entity QCS_4_QCS_no_lut_2_0_QCS_no_lut is
  port (
  ...
  attribute ORIG_REF_NAME of QCS_4_QCS_no_lut_2_0_QCS_no_lut : entity is "QCS_no_lut";
end QCS_4_QCS_no_lut_2_0_QCS_no_lut;

architecture STRUCTURE of QCS_4_QCS_no_lut_2_0_QCS_no_lut is
  ...
  signal \rpmlut_addr[13]_i_5_n_0\ : STD_LOGIC;
...
en_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
en_INST_0_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
en_INST_0_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\rpmlut_addr[13]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \rpmlut_addr[13]_i_4_n_0\,
      I3 => clk_counter(14),
      I4 => \rpmlut_addr[13]_i_5_n_0\,
      O => \rpmlut_addr[13]_i_2_n_0\
    );
\rpmlut_addr[13]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\rpmlut_addr[13]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity QCS_4_QCS_no_lut_2_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    ch_a : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of QCS_4_QCS_no_lut_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of QCS_4_QCS_no_lut_2_0 : entity is "QCS_4_QCS_no_lut_2_0,QCS_no_lut,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of QCS_4_QCS_no_lut_2_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of QCS_4_QCS_no_lut_2_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of QCS_4_QCS_no_lut_2_0 : entity is "QCS_no_lut,Vivado 2023.1";
end QCS_4_QCS_no_lut_2_0;

architecture STRUCTURE of QCS_4_QCS_no_lut_2_0 is
  signal \<const0>\ : STD_LOGIC;
  signal \^rpm\ : STD_LOGIC_VECTOR ( 15 downto 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_RESET rst, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 180.0, CLK_DOMAIN QCS_4_clk_0, INSERT_VIP 0";
...
inst: entity work.QCS_4_QCS_no_lut_2_0_QCS_no_lut
     port map (
      E(0) => en,
      REC(31 downto 0) => REC(31 downto 0),
      RPM(15 downto 0) => \^rpm\(15 downto 0),
